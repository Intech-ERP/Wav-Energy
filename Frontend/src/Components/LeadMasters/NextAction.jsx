...
export default function NextAction({ tabValue, onEditData, refreshKey }) {
     const { data, refetch, setData } = useFetchData(`${tabValue}`);
      ...
      const updateDisplayOrder = async (dispValue, row) => {
          try {
              ...
              const updateId = row.original.next_action_id;
      ...
      const column = [
          { id: 1, accessorKey: "next_action", header: "Next Action" },
          {
              id: 2,
